...
_board.AddQuote(
    new Quote("Paul",
            "God hath not given us the spirit of fearbut of power, love, and of a sound mind.",
...
_board.AddQuote(
    new Quote("Alma",
            "If ye have faith, ye have hope for things which are not seen, which are true.",
